...
# 定义文件路径（请修改为实际路径）
Drop_folder = '/home/bo/High-Precision-Congestion-Control/result/motivation/PFC-incast.txt'
...
try:
    ...
    # sih_x, sih_y = read_data_file('DCQCN_fct.txt')
...
plt.tight_layout()
plt.savefig('motivation1.png')  # 将图像保存为'loss_curves.png'
plt.savefig("motivation1.svg", dpi=600,format="svg")
plt.show()