...
try:
    dsh_x, dsh_y = read_data_file('Drop_fct.txt')
...
plt.tight_layout()
plt.savefig('motivation2.png')  # 将图像保存为'loss_curves.png'
plt.savefig("motivation2.svg", dpi=600,format="svg")
plt.show()