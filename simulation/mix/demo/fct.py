...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--statsfile', type=str, default="/home/bo/High-Precision-Congestion-Control/result/motivation/Drop_fct_stats.txt")
    ...
    if average_value is not None:
        ...
        with open(args.statsfile, 'a') as stats_file:
            stats_file.write(f"avg: {average_value} μs avg: {average_slowdown} μs tail:{last_fct} μs\n")
    else:
