...
def generate_flow(num_workers, total_traffic=102230000, node_range=144, rack_size=9):
    num_job = 1
...
# def generate_flow(num_workers, total_traffic=26500000, node_range=256, rack_size=16):
#     num_job = 1
#     num_ps = max(1, int(num_workers / 4))  # 至少1个PS
